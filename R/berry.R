...
berry <- list(
  ...
  "5.8" = c("#4F2463FF", "#643B76FF", "#7A528AFF", "#8F699DFF",
            "#A580B1FF", "#BB97C4FF", "#D0AED8FF", "#E6C5EBFF"),
  ...
  "5.5" = c("#4F2463FF", "#714882FF", "#946DA1FF", "#B692C0FF", "#D9B7DFFF"),
  ...
  "5.3" = c("#4F2463FF", "#886197FF", "#C29ECBFF")
)
