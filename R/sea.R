#' List of watery palettes. Palettes are 5, 3, or 8 values long.
#'
#' @export
#'
sea <- list(
  ...
  "4.8" = c("#004D49FF", "#1F635FFF", "#3F7976FF", "#5F8F8DFF",
            "#7FA5A3FF", "#9FBBBAFF", "#BFD1D1FF", "#DFE8E8FF"),
  "5.8" = c("#00496EFF", "#1F5D7CFF", "#3E718AFF", "#5D8698FF",
            "#7D9AA6FF", "#9CAFB3FF", "#BBC3C2FF", "#DBD8D0FF"),
  ...
  "4.5" = c("#004D49FF", "#377370FF", "#6F9A98FF", "#A7C1C0FF", "#DFE8E8FF"),
  "5.5" = c("#00496EFF", "#366C86FF", "#6D909FFF", "#A4B4B7FF", "#DBD8D0FF"),
  "1.3" = c("#0D2B52FF", "#5D718BFF", "#AEB8C5FF"),
  "2.3" = c("#006778FF", "#6FA9B3FF", "#DFECEEFF"),
  "3.3" = c("#202D85FF", "#5E7297FF", "#9CB9AAFF"),
  "4.3" = c("#004D49FF", "#6F9A98FF", "#DFE8E8FF"),
  "5.3" = c("#00496EFF", "#6D909FFF", "#DBD8D0FF")
)
